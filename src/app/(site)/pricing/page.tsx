...
import { getMergedSettings, getPricingPackages } from "@/lib/data";
      ...
      <PageShell>
          <div className="mb-12 max-w-3xl sm:mb-16">
            ...
            <p className="mt-4 text-base leading-relaxed text-soft-black/75">
              ...
              complexity, deliverables, and timeline. Share your vision to
              receive a custom quote designed around what your brand actually
              needs.
            </p>
          </div>
